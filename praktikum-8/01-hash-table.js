class HashMap {
    constructor(kapasitas = 53) {
     ...
     ['javascript', 'python', 'java', 'C++', 'rush', 'go', 'typescript'].forEach((lang,i) => map.set(i+1));


     console.log('=== HashMap Demo ===');
     console.log('get(java)       :', map.get('java'));
     console.log('get(kotlin)     :', map.get('kotlin'));
     console.log('has(phython)    :', map.has('python'));
     map.delete('java');
     console.log('Setelah hapus java:', map.get('java'));
